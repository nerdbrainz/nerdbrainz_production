  ...
  return (
    ...
    >
      <div className="container mx-auto flex px-5 pt-24  md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <p className="mb-8 leading-relaxed text-custom-color-ten">
            ...
            website the most important asset.
            <br />
            <br />
            Your website is a reflection of what your business represents and a
            showcase for what you stand for in the marketplace. With ever more
            tech savvy consumers a unique and well functioning site is
            ...
            Working with a strong web designer you get to share your aspirations
            and future plans for your business. Then in collaboration your team
            the websites designers can build a platform that will perfectly
            reflect your concept and expand with your growing business. adding
            pages blogs new products and market strategies when needed
          </p>
        </div>
      </div>
      <div className="flex flex-wrap -mx-1 overflow-hidden mx-5 pb-10 sm:-mx-1 md:-mx-2 lg:-mx-1 xl:-mx-1 lg:px-12 md:items-start md:text-left items-center text-center">
        <div className="my-1 px-1 w-full overflow-hidden sm:my-1 sm:px-1 md:my-2 md:px-2 lg:my-1 lg:px-1 xl:my-1 xl:px-1 sm:px-10 text-custom-color-ten  ">
          <p>
            ...
            becoming intuitively better able to spot websites that have been
      ...
      <div classNameName="ml-44">
        <div classNameName="absolute w-3/5 h-32 top-3/5 left-1/3   bg-custom-color-four rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob animation-delay-2000 z-0 "></div>

        <div classNameName="absolute w-2/5 h-24 top-1/2 left-4  bg-custom-color-six rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-6000"></div>

        <div classNameName="absolute w-2/5 h-24 top-1/2 left-1/3   bg-custom-color-five rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
