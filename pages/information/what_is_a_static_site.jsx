        ...
        <div className="container mx-auto flex px-5 pt-24  md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p className="mb-8 leading-relaxed text-custom-color-ten">
              A static site is the perfect option for businesses wanting to
              convey information but not necessarily use their site heavily for
              sales or high customer interaction. A good example of an optimum
              static website user would be a boutique hotel, restaurant or
              hairdressing service. Businesses like these need to be able to
              show the potential customers what their business represents and
              the clientele that it is best suited for. The essential
              information is often limited to opening times, a list of services,
              price list or a menu and a way of contacting or finding that
              business. A booking service is often a popular addition to this
              kind of website.
              <br />
              Static sites are also preferred by organisations such as legal,
              financial, management services. Organisations where the main
              purpose of the site is to tell the customer what they can expect
              from their services and how to get in contact.
              <br />
              <br />A static site normally consists of, but not limited to a
              Landing Page, an About Us Page and a Contact Page.
            </p>
            <br />
            ...
            <p className="mb-8 leading-relaxed text-custom-color-ten">
              ...
              website. It is good to think of the Landing Page as your
              shopfront, as it represents your company. Customers will
              interoperate what you stand for in the first few seconds they
              visit you at your site. A well designed and built custom site will
              help with this. As modern internet users really understand and
              appreciate quality.
            </p>
            <br />
          </div>
        ...
        <div className="flex flex-wrap -mx-1 overflow-hidden mx-5  sm:-mx-1 md:-mx-2 lg:-mx-1 xl:-mx-1 lg:px-8 md:items-start md:text-left items-center text-center">
          <div className="my-1 px-1 w-full overflow-hidden sm:my-1 sm:px-1 md:my-2 md:px-2 lg:my-1 lg:px-1 xl:my-1 xl:px-1 sm:px-10 text-custom-color-ten  pb-24">
            ...
            <p className="mb-8 leading-relaxed text-custom-color-ten">
              ...
              communicate in greater depth your vision for your company and
              where you feel it belongs in the world. The about page is also a
              great opportunity for you to share your credentials and experience
              with potential clients and should be viewed as a further way to
            ...
            <p className="mb-8 leading-relaxed text-custom-color-ten">
              The contact page is there to tell customers how to get in touch
              with you. If you are at a geographical location it should have
              your address and often a google map view and link to make it
              easier for the customer to find you. Opening times, telephone and
              email information are all standard.
              <br />
              For many the contact page is a great opportunity to develop a
              stronger relationship with your potential clients. With an
              integrated marketing automation platform you can collect client
              email addresses in a database. So in the future you can create an
            ...
            <p className="mb-8 leading-relaxed text-custom-color-ten">
              This is an opportunity for a more in-depth look at what your
              company aspires to and what it represents. Further pages are often
              used to show examples of your work, share case studies and
              testimonials from happy customers. These pages help your business
              by really showing the world your full capabilities, but equally
              importantly and often overlooked or misunderstood is SEO. SEO or
              search engine optimization simply put is your ranking on a search
              engine like google. Essentially how close to the top of a search
              will your website land. Of course you can pay the likes of google
              to be higher up on their search engines. However a well written
              website with the write key words will strongly increase your
              visibility and likelihood that your site will rank higher.
              <br />
              <br />
            ...
            <p className="mb-8 leading-relaxed text-custom-color-ten">
              ...
              individuals interested but undecided about what they want, or what
              their exact needs actually are. At the same time converting those
              readers into customers. Blogs are now commonplace with many
              services offering pre-written or professionally written custom
              blogs for those that don’t have the time or inclination to write
              their own.
            </p>
            ...
            <p className="mb-8 leading-relaxed text-custom-color-ten">
              ...
              need to share information. Buying a custom website is an
              investment and will help to future proof your company. As many
              static websites can grow and evolve just like your company with
              the possibility of building on the basic website down the line.
              Adding E-commerce capabilities payment fulfilment even online
              course systems.
            </p>
          </div>
        </div>
