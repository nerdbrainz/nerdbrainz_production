                  ...
                  <div className="w-full lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                      ...
                      <p className="leading-relaxed my-5 text-xl">
                        ...
                        artisan food products with the best coffee in town.
                        Bring some friends down and enjoy the atmosphere and
                        friendly environment. Your friends will appreciate you
                        introducing them to the most poorly kept secret in the
                        city.
                      </p>
                  ...
                  <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                      ...
                      <p className="leading-relaxed my-5 text-xl">
                        ...
                        love. But there is only one way we get there, and that
                        is treating every customer like they mean something to
                        us. Because they do. We do not just want to build web
                        sites and never talk to the customer again.
                      </p>
                      <p className="leading-relaxed text-xl">
                        We want to bring success into our customers lives and
                        help them fix business intelligence mistakes and
                        compound on the things that they are already doing
                        right. We want to bring E-commerce solutions and
                        business intelligence to every one so that they can make
                        the most of the resources they have and we can all
                        retire early.{" "}
