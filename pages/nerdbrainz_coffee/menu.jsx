...
const Menu = () => {
  return (
    <>
      <Meta
        title="Menu | Nerd Brainz Coffee | An example of a beautiful menu that offers a responsive web design. This template or one similar to it could be yours"
        desc="A businesses menu is their offering to the world. This menu is available to all users and able to be viewed in most any device so customers can benefit from a truly responsive mobile first web design. Nerd Brainz offers websites and e-commerce solutions to get your company online and take part in the online economy."
      />
      <div>
        <CoffeeNavbar />
        <div className="min-h-screen bg-yellow-50">
          ...
          <section id="mobile-only-view" className="md:hidden bg-yellow-50">
            ...
            <h2 className="text-2xl md:text-5xl my-12 border-b-2 border-custom-tan font-bold pb-3 text-center">
              COLD DRINKS -{" "}
              <span className="text-base font-semibold">20 OZ</span>
            </h2>
            <MobileMenuItem
              title="Cold Brew"
              description="Our signature cold brew. Made with a mixture of latin and african coffees from the edges of the rainforrest"
