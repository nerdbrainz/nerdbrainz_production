          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
              ...
              <p className="leading-relaxed text-lg">
                ...
                and the fact that you can always get a top notch cup of coffee
                in the morning. Nerd Brainz is the spot to people watch, and
                mingle. There is always professionals, hipsters, artists
                basically everyone you could ever want to meet enjoying a cup of
                coffee and enjoying the ambience. Nerd Brainz coffee is my
              ...
              <div className="p-4 md:w-1/3 flex">
                <div className="flex-grow pl-6  text-center">
                  ...
                  <p className="leading-relaxed text-base mb-5">
                    ...
                    seat and stool is designed to make you feel at
                    NerdbrainzCoffeeHome, and we happily accommodate people with
                    disabilities.
                  </p>
                  <a className="mt-3 text-custom-tan inline-flex items-center border-2 border-custom-tan p-5 rounded-lg">
                    Learn More
